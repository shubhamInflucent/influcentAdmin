    ...
    <Flex bg={backgroundColor} w="100%" h="60px" justify="center" position='fixed' zIndex={100}>
      <Flex w={isGreaterThan1000 ? '80%' : "95%"} justify="space-between" alignItems="center">
        ...
        <Flex alignItems='center' gap='10px' w='100%' justify='end'>
          ...
          {isGreaterThan600 && <Button onClick={()=> navigate('/contact')} bg='#0081DF' maxW='170px' minW='80px' w='100%' colorScheme='blue' fontWeight='400' fontSize='13px' h='35px'>Contact Us</Button>}
        </Flex>
      </Flex>
    </Flex>
  );
